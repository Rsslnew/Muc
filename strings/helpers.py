...
/pause ᴏʀ /cpause - ᴜɴᴛᴜᴋ ᴍᴇɴᴊᴇᴅᴀ ᴍᴜsɪᴋ ᴍᴜ.
/resume ᴏʀ /cresume - ᴜɴᴛᴜᴋ ᴍᴇʟᴀɴᴊᴜᴛᴋᴀɴ ᴍᴜsɪᴋ ᴍᴜ.
/mute ᴏʀ /cmute - Mᴜᴛᴇ ᴛʜᴇ ᴘʟᴀʏɪɴɢ ᴍᴜsɪᴄ.
/unmute ᴏʀ /cunmute - Uɴᴍᴜᴛᴇ ᴛʜᴇ ᴍᴜᴛᴇᴅ ᴍᴜsɪᴄ.
/skip ᴏʀ /cskip - - ᴍᴇʟᴀɴᴊᴜᴛᴋᴀɴ ᴍᴜsɪᴋ ᴛᴀɴᴘᴀ ʜᴀʀᴜs sᴇʟᴇsᴀɪ.
/stop ᴏʀ /cstop - sᴛᴏᴘ ᴍᴜsɪᴋ ᴋᴀᴍᴜ ᴅɪ ɢʀᴏᴜᴘ ɪɴɪ.
/shuffle ᴏʀ /cshuffle - Rᴀɴᴅᴏᴍʟʏ sʜᴜғғʟᴇs ᴛʜᴇ ǫᴜᴇᴜᴇᴅ ᴘʟᴀʏʟɪsᴛ.
/seek  ᴏʀ /cseek - ᴍᴇᴍᴘᴇʀᴄᴇᴘᴀᴛ ᴅᴜʀᴀsɪ ᴍᴜsɪᴋ ᴀᴛᴀᴜ ᴠɪᴅᴇᴏɴʏᴀ.
/seekback ᴏʀ /cseekback - ᴍᴇɴɢᴇᴍʙᴀʟɪᴋᴀɴ ᴅᴜʀᴀsɪ ᴡᴀᴋᴛᴜ sᴇʙᴇʟᴜᴍɴʏᴀ.
/reboot - ʀᴇʙᴏᴏᴛ ʙᴏᴛ ᴅɪ ᴅᴀʟᴀᴍ ɢʀᴜᴘ ᴍᴜ . .

✅<u>Sᴘᴇᴄɪғɪᴄ Sᴋɪᴘ:</u>
/skip ᴏʀ /cskip [Nᴜᴍʙᴇʀ(ᴇxᴀᴍᴘʟᴇ: 𝟹)] 
    - ᴍᴇʟᴀɴᴊᴜᴛᴋᴀɴ ᴍᴜsɪᴄ ᴛᴏ ᴀ ᴛʜᴇ sᴘᴇᴄɪғɪᴇᴅ ǫᴜᴇᴜᴇᴅ ɴᴜᴍʙᴇʀ. Exᴀᴍᴘʟᴇ: /sᴋɪᴘ 𝟹 ᴡɪʟʟ sᴋɪᴘ ᴍᴜsɪᴄ ᴛᴏ ᴛʜɪʀᴅ ǫᴜᴇᴜᴇᴅ ᴍᴜsɪᴄ ᴀɴᴅ ᴡɪʟʟ ɪɢɴᴏʀᴇ 𝟷 ᴀɴᴅ 𝟸 ᴍᴜsɪᴄ ɪɴ ǫᴜᴇᴜᴇ.
...
/play ᴏʀ /vplay ᴏʀ /cplay  - ʙᴏᴛ ᴀᴋᴀɴ ᴍᴇᴍᴜᴛᴀʀ ʟᴀɢᴜ ᴊɪᴋᴀ ᴋᴀᴍᴜ ᴍᴇᴍʙᴇʀɪᴋᴀɴ ᴘᴇʀɪɴᴛᴀʜ ᴅᴀɴ ᴊᴜᴅᴜʟ ʟᴀɢᴜɴʏᴀ.
...
/channelplay [Cʜᴀᴛ ᴜsᴇʀɴᴀᴍᴇ ᴏʀ ɪᴅ] ᴏʀ [Dɪsᴀʙʟᴇ] - ᴍᴇɴɢʜᴜʙᴜᴋᴀɴ ᴋᴇ ᴄʜᴀɴɴᴇʟ ᴋᴀᴍᴜ ᴜɴᴛᴜᴋ ᴍᴇᴍᴜᴛᴀʀ ʟᴀɢᴜ, ᴋᴇᴛɪᴋ ᴘᴇʀɪɴᴛᴀʜ ɴʏᴀ ᴅɪ ɢʀᴏᴜᴘ ᴋᴀᴍᴜ.
...
/sudolist - ᴍᴇɴɢᴇᴄᴇᴋ ᴅᴀғᴛᴀʀ sᴜᴅᴏ ᴅɪ ʙᴏᴛ ᴍᴜsɪᴋ ɪɴɪ

/lyrics [Mᴜsɪᴄ Nᴀᴍᴇ] - ᴍᴇɴᴄᴀʀɪ ʟʏʀɪᴄs ᴍᴜsɪᴋ ᴍᴇʟᴀʟᴜɪ ᴡᴇʙ.

/song [Tʀᴀᴄᴋ Nᴀᴍᴇ] ᴏʀ [YT Lɪɴᴋ] - ᴅᴏᴡɴʟᴏᴀᴅ ʟᴀɢᴜ ᴅɪ ʏᴏᴜᴛᴜʙᴇ ɪɴ ᴍᴘ𝟹 ᴏʀ ᴍᴘ𝟺 ғᴏʀᴍᴀᴛs.

/player -  Gᴇᴛ ᴀ ɪɴᴛᴇʀᴀᴄᴛɪᴠᴇ Pʟᴀʏɪɴɢ Pᴀɴᴇʟ.

c sᴛᴀɴᴅs ғᴏʀ ᴄʜᴀɴɴᴇʟ ᴘʟᴀʏ.

/queue ᴏʀ /cqueue - ʟɪsᴛ ᴅᴀғᴛᴀғ ᴍᴜsɪᴋ ᴋᴀᴍᴜ ʙᴀʙʏ.

/tr - ᴛʀᴀɴsʟᴀᴛᴇ ᴛᴇxᴛ ʀᴇᴘʟʏ ᴘᴇsᴀɴ ɴʏᴀ."""

HELP_4 = """✅<u>Gʀᴏᴜᴘ Sᴇᴛᴛɪɴɢs:</u>
/settings - ᴍᴇʟɪʜᴀᴛ ᴅᴀғᴛᴀʀ sᴇᴛᴛɪɴɢ ᴡɪᴛʜ ɪɴʟɪɴᴇ ʙᴜᴛᴛᴏɴs
...
/broadcast [ᴍᴇssᴀɢᴇ ᴏʀ ʀᴇᴩʟʏ ᴛᴏ ᴀ ᴍᴇssᴀɢᴇ] » ᴍᴇɴɢɪʀɪᴍ ᴘᴇsᴀɴ ᴋᴀᴍᴜ ᴍᴇʟᴀʟᴜɪ ʙᴏᴛ, ᴏɴʟʏ sᴜᴅᴏ ᴅᴀɴ ᴏᴡɴᴇʀ
